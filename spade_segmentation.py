...
def spade_segmentation_train(clipped_signal, resampled_data, Ls, win_len, win_shift, ps_maxit, ps_epsilon, ps_r, ps_s, F_red, masks):
  ...
  for n in tqdm(range(N), desc="Processing", unit="iteration"):
    ...
    data_rec_block, metrics = ml_aspade_train(data_block, masks_seg, ps_Ls, ps_maxit, ps_epsilon, ps_r, ps_s, F_red)
  ...
  return data_rec_fin, metrics, training_data


def spade_segmentation_eval(clipped_signal, resampled_data, Ls, win_len, win_shift, ps_maxit, ps_epsilon, ps_r, ps_s, F_red, masks, model_path, k_classes):
  ...
  for n in tqdm(range(N), desc="Processing", unit="iteration"):
    ...
    data_rec_block = ml_aspade_eval(data_block, masks_seg, ps_Ls, ps_maxit, ps_epsilon, ps_r, ps_s,F_red, model_path, k_classes)
